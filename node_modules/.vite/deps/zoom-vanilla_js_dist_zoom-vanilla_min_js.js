...
var require_zoom_vanilla_min = __commonJS({
  "node_modules/zoom-vanilla.js/dist/zoom-vanilla.min.js"() {
    +function() {
      "use strict";
      function e(e2) {
      ...
      (function() {
        function e2() {
          document.body.addEventListener("click", function(e3) {
            e3.target.getAttribute("data-action") === "zoom" && e3.target.tagName === "IMG" && t2(e3);
          });
        }
        function t2(e3) {
...
// dep:zoom-vanilla_js_dist_zoom-vanilla_min_js
var zoom_vanilla_js_dist_zoom_vanilla_min_js_default = require_zoom_vanilla_min();
export {
  zoom_vanilla_js_dist_zoom_vanilla_min_js_default as default
};
//# sourceMappingURL=zoom-vanilla_js_dist_zoom-vanilla_min_js.js.map
