...
<div class="text-gray-700 pt-9 sm:pt-10">
    ...
    <main id="content">
        ...
        <!-- =========={ FOOTER }==========  -->
        <footer class="bg-[#d0b555] text-black">
            <!--Footer content-->
                    ...
                    <div class="flex flex-wrap flex-row lg:justify-between -mx-3">
                        <div class="flex-shrink max-w-full w-full lg:w-2/5 px-3 lg:pr-16">
                            <div class="flex items-center mb-2">
                                <span class="text-3xl leading-normal mb-2 font-bold text-black mt-2">SISDJATAN</span>
                        ...
                        <div class="flex-shrink max-w-full w-full lg:w-3/5 px-3">
                            <div class="flex flex-wrap flex-row">
                                ...
                                <div class="flex-shrink max-w-full w-1/2 md:w-1/4 mb-6 lg:mb-0">
                                    <h4 class="text-base leading-normal mb-3 uppercase text-black">Situs terkait</h4>
                                    <ul>
            ...
            <div class="footer-dark bg-[#ce7e00] border-t border-gray-200 border-opacity-100">
                <div class="container py-4 ">
                    <div class="row">
                        <div class="col-12 col-md text-center">
                            <p class="d-block my-3 text-black">Copyright © SISDJATAN (sistem informasi sumber daya air jalan jembatan)</p>
                        </div>
                    </div>
                </div>
            </div>
