<template>
    <div class="grid grid-cols-12 gap-6">
        <div class="box col-span-12 lg:col-span-12">
            ...
            <div class="p-5 border">
                <div class="form-inline">
                    ...
                    <input type="text" class="form-control" placeholder="ketik disini..." v-model="river.fid" />
                </div>
        ...
        <div class="box col-span-12 lg:col-span-6">
            <div class="p-5">
                <div class="form-inline">
                    <label class="form-label sm:w-20">Orde</label>
                    <select class="form-select mt-2 sm:mr-2" aria-label="Default select example">
                        <option>--Pilih salah satu--</option>
                        <option>Orde 1</option>
                        <option>Orde 2</option>
                        <option>Orde 3</option>
                        <option>Orde 4</option>
                        <option>Orde 5</option>
                    </select>
                </div>
                <div class="form-inline mt-5">
        ...
        <div class="box col-span-12 lg:col-span-6">
            ...
            <div class="p-5">
                ...
                <div class="form-inline mt-5">
                    ...
                    <input type="text" class="form-control" v-model="river.Video" placeholder="ketik disini..." />
                </div>
                <div class="form-inline mt-5">
                    <label class="form-label sm:w-30 capitalize">peta</label>
                    <input type="text" class="form-control" v-model="river.Peta" placeholder="ketik disini..." />
                </div>
            </div>
        </div>
    </div>
