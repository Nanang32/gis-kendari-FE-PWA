        ...
        <div class="box col-span-12 lg:col-span-6">
            ...
            <div class="p-5">
                ...
                <div class="form-inline mt-5">
                    ...
                    <input type="text" class="form-control" v-model="irrigation.Video" placeholder="ketik disini..." />
                </div>
                <div class="form-inline mt-5">
                    <label class="form-label sm:w-30 capitalize">peta</label>
                    <input type="text" class="form-control" v-model="irrigation.Peta" placeholder="ketik disini..." />
                </div>
            </div>
        </div>
