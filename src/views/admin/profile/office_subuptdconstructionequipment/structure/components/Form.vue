<template>
    <div class="intro-y box p-5">
        <div>
            ...
            <input type="text" class="form-control w-full" placeholder="Input text" v-model="roomPackage.name" :disabled="loading" />
        </div>
        <div v-if="!loading">
            <label class="form-label">Ketik dibawah ini..</label>
            <ClassicEditor class="form-control w-full" placeholder="Input text" v-model="roomPackage.desc" />
