<template>
    <div class="intro-y flex items-center mt-8">
        <h2 class="text-lg font-medium mr-auto capitalize">Data Kinerja pekerjaan Bidang pelaksanaan Jaringan Sumber air</h2>
    </div>
                ...
                <table class="table table-report mt-2">
                    <thead>
                        <tr>
                            ...
                            <th class="whitespace-nowrap">Normalisasi Sungai</th>
                            <th class="whitespace-nowrap">Pengaman Pantai</th>
                            <th class="whitespace-nowrap">Bronjong/Talud/DLl</th>
