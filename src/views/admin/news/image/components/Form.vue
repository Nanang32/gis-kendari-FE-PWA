<template>
    <div class="pos intro-y grid grid-cols-12 gap-5 mt-5">
        ...
        <div class="intro-y col-span-12 lg:col-span-8">
            <input type="text" class="intro-y form-control py-3 px-4 box pr-10" placeholder="Title" v-model="image.title" />
                ...
                <div class="post__content">
                    <div class="p-5">
                        <div class="border border-slate-200/60 dark:border-darkmode-400 rounded-md p-5">
                            ...
                            <editor v-model="image.description" :init="{
                                height: 500,
                                menubar: true,
                                plugins: [
                        ...
                        <div class="border border-slate-200/60 dark:border-darkmode-400 rounded-md p-5 mt-5">
                            ...
                            <div class="mt-5">
                                <div class="mt-3">
                                    ...
                                    <TomSelect id="post-form-3" v-model="image.categories" class="w-full" multiple>
                                        <option
...
function onFileChange(e) {
    props.image.image_file = e.target.files[0];
}
