                ...
                <div class="flex flex-wrap flex-row lg:justify-between -mx-3">
                    ...
                    <div class="flex-shrink max-w-full w-full lg:w-3/5 px-3">
                        <div class="flex flex-wrap flex-row">
                            <div class="flex-shrink max-w-full w-1/3 md:w-2/4 mb-6 lg:mb-0">
                                <h4 class="text-base leading-normal mb-3 uppercase text-black">Contact Us</h4>
                                <ul>
                                    <li class="py-1 hover:text-white hover:text-white capitalize">
                                        <MapIcon class="w-4 h-4 mr-1 inline-block" />Jalan Haluoleo No. 05 Kompleks Perkantoran Bumi Praja Anduonohu, Kota Kendari</li>
                                    <li class="py-1 hover:text-white"><PhoneIcon class="w-4 h-4 mr-1 inline-block"/>0402 (000000)</li>
                                    <li class="py-1 hover:text-white"><MailIcon class="w-4 h-4 mr-1 inline-block"/> sisdjatan.sdabmsultra@gmail.com</li>
                                </ul>
                            </div>
                            <div class="flex-shrink max-w-full w-1/3 md:w-2/4 mb-6 lg:mb-0 ml-10">
                                ...
                                <ul>
                                    ...
                                    <li class="py-1 hover:text-white"><a href="https://lpse.sultraprov.go.id/eproc4" target="_blank">LPSE Prov.Sultra</a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
